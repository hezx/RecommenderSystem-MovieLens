...
class SVD: public MovieLensModel{

public:
	SVD(std::string projid, int nfactor, double g0, double l0, int bi, double g1, double g2, double l6, double l7, double a, double sr, int mi, bool debug);
	void train();
	void predict();
	~SVD(){}
...
private:
	...
	vector2F p_, q_;   // user character Matrix
